...
public class ProgressDialog extends JFrame implements ProgressListener {
	...
	private static final ImageIcon[] TICKS = new ImageIcon[] {
			new ImageIcon(Thread.currentThread()
					...
					.getResource("com/denkbares/progress/spinner_0.png")),
			new ImageIcon(Thread.currentThread()
					.getContextClassLoader()
					.getResource("com/denkbares/progress/spinner_1.png")),
			new ImageIcon(Thread.currentThread()
					.getContextClassLoader()
					.getResource("com/denkbares/progress/spinner_2.png")),
			new ImageIcon(Thread.currentThread()
					.getContextClassLoader()
					.getResource("com/denkbares/progress/spinner_3.png")),
			new ImageIcon(Thread.currentThread()
					.getContextClassLoader()
					.getResource("com/denkbares/progress/spinner_4.png")),
			new ImageIcon(Thread.currentThread()
					.getContextClassLoader()
					.getResource("com/denkbares/progress/spinner_5.png")),
			new ImageIcon(Thread.currentThread()
					.getContextClassLoader()
					.getResource("com/denkbares/progress/spinner_6.png")),
			new ImageIcon(Thread.currentThread()
					.getContextClassLoader()
					.getResource("com/denkbares/progress/spinner_7.png")),
			new ImageIcon(Thread.currentThread()
					.getContextClassLoader()
					.getResource("com/denkbares/progress/spinner_8.png")),
			new ImageIcon(Thread.currentThread()
					.getContextClassLoader()
					.getResource("com/denkbares/progress/spinner_9.png"))
	};
