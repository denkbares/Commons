...
/**
 * Event fired when a new SemanticCore instance has been created.
 *
 * @author Albrecht Striffler (denkbares GmbH)
 * @since 2026-02-13
 */
public class SemanticCoreCreatedEvent implements Event {

	private final SemanticCore semanticCore;

	public SemanticCoreCreatedEvent(SemanticCore semanticCore) {
