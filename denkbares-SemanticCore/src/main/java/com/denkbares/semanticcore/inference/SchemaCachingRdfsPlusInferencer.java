 ...
 * @created 26.02.2025
 */
public class SchemaCachingRdfsPlusInferencer extends NotifyingSailWrapper {

	private static final Logger logger = LoggerFactory.getLogger(SchemaCachingRdfsPlusInferencer.class);
	 ...
	 */
	public SchemaCachingRdfsPlusInferencer() {
		super();
	 ...
	 */
	public SchemaCachingRdfsPlusInferencer(NotifyingSail data) {
		super(data);
		predefinedSchema = null;
	}
	 ...
	 */
	public SchemaCachingRdfsPlusInferencer(NotifyingSail data, Repository predefinedSchema) {
		super(data);
	 ...
	 */
	public SchemaCachingRdfsPlusInferencer(NotifyingSail data, boolean useAllRdfsRules) {
		super(data);
		predefinedSchema = null;
	...
	public void init()
		...
		try (final SchemaCachingRdfsPlusInferencerConnection conn = getConnection()) {
			conn.begin();
	...
	@Override
	public SchemaCachingRdfsPlusInferencerConnection getConnection()
			throws SailException {
		InferencerConnection e = (InferencerConnection) super.getConnection();
		return new SchemaCachingRdfsPlusInferencerConnection(this, e);
	}
	 ...
	 * @return inferencer
	 */
	static public SchemaCachingRdfsPlusInferencer fastInstantiateFrom(
			SchemaCachingRdfsPlusInferencer sailToInstantiateFrom, NotifyingSail store) {
	...
	static public SchemaCachingRdfsPlusInferencer fastInstantiateFrom(
		...
		SchemaCachingRdfsPlusInferencer ret = new SchemaCachingRdfsPlusInferencer(store,
	...
	void calculateInferenceMaps(SchemaCachingRdfsPlusInferencerConnection conn, boolean addInferred) {
